...
import coolingImgRight from "../../../../assets/img/cooling1.png";
import coolingImgCenter from "../../../../assets/img/cooling2.png";
import coolingImgLeft from "../../../../assets/img/cooling3.png";
                ...
                <div className={styles.column}>
                    <div className={`${styles.imageWrapper} ${styles.redBorder}`}>
                        <img
                            ...
                            className={`${styles.image} ${styles.imgLeft}`}yn bjh
                        />
                    </div>
